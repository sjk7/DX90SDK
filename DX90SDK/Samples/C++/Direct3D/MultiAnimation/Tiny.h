...
#define FOOTFALLSOUND00     _T("footfall00.wav")
#define FOOTFALLSOUND01     _T("footfall01.wav")
...
protected:
    ...
    vector<CTiny*>      *m_pv_pChars;         // pointer to global array of CTiny* s
...
public:
    ...
    CTiny();
    virtual ~CTiny();
    virtual HRESULT Setup( CMultiAnim *pMA, vector< CTiny* > *pv_pChars, CSoundManager *pSM, double dTimeCurrent );
