...
TCHAR              g_strPlayerName[MAX_PLAYER_NAME];        // Local player name
                        ...
                        LPTSTR pCmdLine, INT nCmdShow )
{
    ...
    DXUtil_ReadStringRegKeyCch( hDPlaySampleRegKey, TEXT("Player Name"), 
                             g_strPlayerName, MAX_PLAYER_NAME, TEXT("TestPlayer") );
                                     ...
                                     WPARAM wParam, LPARAM lParam )
{
    ...
    switch( msg ) 
    {
        ...
        case WM_DESTROY:
        {
            GetDlgItemText( hDlg, IDC_PLAYER_NAME, g_strPlayerName, MAX_PLAYER_NAME );
                                     ...
                                     DPL_CONNECTION_SETTINGS** ppdplConnectSettings ) 
{
    ...
    GetDlgItemText( hDlg, IDC_PLAYER_NAME, strPlayerName, MAX_PLAYER_NAME );
    ...
    else
    {
        ...
        DXUtil_ConvertGenericStringToWideCch( wstrPlayerName, strPlayerName, MAX_PLAYER_NAME );
