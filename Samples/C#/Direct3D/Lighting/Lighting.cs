...
namespace Lighting
{
	...
	public class MyGraphicsSample : GraphicsSample
	{
		...
		protected override void FrameMove()
		{
			...
			if (!Caps.VertexProcessingCaps.SupportsPositionalLights)
			{
			...
			byte r = (byte)Math.Abs(0.5f + 0.5f * x * 0xff);
			byte g = (byte)Math.Abs(0.5f + 0.5f * y * 0xff);
			byte b = (byte)Math.Abs(0.5f + 0.5f * z * 0xff);
