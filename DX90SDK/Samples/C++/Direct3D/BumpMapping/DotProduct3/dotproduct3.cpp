...
HRESULT CMyD3DApplication::CreateFileBasedNormalMap()
{
    ...
    if( FAILED( hr = DXUtil_FindMediaFileCb( strPath, sizeof(strPath), _T("EarthBump.bmp") ) ) )
        return hr;
    // Load the texture from a file
    if( FAILED( hr = D3DXCreateTextureFromFileEx( m_pd3dDevice, strPath, 
                         D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_A8R8G8B8, 
                         D3DPOOL_MANAGED, D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 
                         D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 0, NULL, NULL, &pFileBasedNormalMapSource ) ) )
