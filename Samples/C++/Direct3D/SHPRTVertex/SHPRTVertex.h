...
//-----------------------------------------------------------------------------
#define SAMPLE_REGKEY     TEXT("Software\\Microsoft\\DirectX 9.0 SDK\\SHPRTVertex")
...
protected:
    ...
    HRESULT SetupVBWithPCAData( ID3DXMesh* pMesh, ID3DXBuffer* pCPCABuffer, D3DXSHPRTBUFFER_DESC desc, DWORD dwNumClusters, DWORD dwNumPCAVectors );
