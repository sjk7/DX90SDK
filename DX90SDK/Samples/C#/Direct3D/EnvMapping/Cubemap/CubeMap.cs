...
namespace CubeMapSample
{
	...
	public class MyGraphicsSample : GraphicsSample
	{
        ...
        private EffectHandle viewMatrixHandle = null;
        private EffectHandle worldMatrixHandle = null;
        private EffectHandle worldViewMatrixHandle = null;
        private EffectHandle projectionMatrixHandle = null;
