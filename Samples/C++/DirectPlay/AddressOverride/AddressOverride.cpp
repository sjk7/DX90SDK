                      ...
                      LPTSTR pCmdLine, INT nCmdShow )
{
    ...
    DXUtil_ReadStringRegKeyCch( hDPlaySampleRegKey, TEXT("Player Name"), 
                             g_strLocalPlayerName, MAX_PLAYER_NAME, TEXT("TestPlayer") );
    ...
    switch( msg ) 
    {
        ...
        {   
            switch( LOWORD(wParam) )
            {
                ...
                case IDOK:
                    GetDlgItemText( hDlg, IDC_PLAYER_NAME, g_strLocalPlayerName, MAX_PLAYER_NAME );
...
HRESULT LaunchMultiplayerGame( HWND hDlg ) 
{
    ...
    DXUtil_ConvertGenericStringToWideCch( wszPeerName, g_strLocalPlayerName, MAX_PLAYER_NAME );
