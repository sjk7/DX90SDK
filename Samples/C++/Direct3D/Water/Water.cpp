...
private:
    ...
    FLOAT       m_bAutoAddDrop;
    FLOAT       m_fAddDropTimer;
    FLOAT       m_fAddDropCountdown;
...
CMyD3DApplication::CMyD3DApplication()
{
    ...
    m_bAutoAddDrop  = TRUE;
    m_fAddDropCountdown = 0.5f;
    m_fAddDropTimer = 0.0f;
...
HRESULT CMyD3DApplication::OneTimeSceneInit()
{
    ...
    // Misc stuff
    m_matPosition._11 = 1.0f;
    m_matPosition._22 = 0.941739f;
    m_matPosition._23 = -0.33634159f;
    m_matPosition._32 = 0.33634159f;
    m_matPosition._41 = 1.3352206f;
    m_matPosition._42 = 6.2386379f;
    m_matPosition._43 = 18.534956f;
    m_matPosition._44 = 1.0f;
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    if(FAILED(hr = D3DXCreateEffectFromFile(m_pd3dDevice, sz, NULL, NULL, dwShaderFlags, NULL, &m_pEffect, NULL)))
        return hr;
...
HRESULT CMyD3DApplication::FrameMove()
{
    ...
    if( m_bAutoAddDrop )
    {
        m_fAddDropTimer -= m_fElapsedTime;
        if( m_fAddDropTimer < 0.0f )
        {
            m_fAddDropTimer = m_fAddDropCountdown;
            m_Water.Drop();
        }
    }
