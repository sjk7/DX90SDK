...
class CMyD3DApplication : public CD3DApplication
{
    ...
    LPDIRECT3DSURFACE9      m_pRenderTargetOneSide;
...
HRESULT CMyD3DApplication::RenderSceneIntoCubeMap()
{
    ...
    for( DWORD i=0; i<6; i++ )
    {
        ...
        m_pd3dDevice->SetRenderTarget( 0, m_pRenderTargetOneSide );
        ...
        m_pd3dDevice->StretchRect( m_pRenderTargetOneSide, NULL, pCubeMapFace, NULL, D3DTEXF_NONE );
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    if( FAILED( hr = m_pSkyBoxObject->Create( m_pd3dDevice, _T("Lobby_skyboxInv.x") ) ) )
...
HRESULT CMyD3DApplication::RestoreDeviceObjects()
{
    ...
    // Create the render target for rendering cube faces
    if( FAILED( hr = m_pd3dDevice->CreateRenderTarget( 256, 256, m_d3dsdBackBuffer.Format, m_d3dSettings.MultisampleType(),
                                                       m_d3dSettings.MultisampleQuality(), FALSE, &m_pRenderTargetOneSide, NULL ) ) )
        return hr;
...
HRESULT CMyD3DApplication::InvalidateDeviceObjects()
{
    ...
    SAFE_RELEASE( m_pRenderTargetOneSide );
