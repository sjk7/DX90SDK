    ...
    TCHAR* strRes, LPDIRECT3DTEXTURE9* ppTex )
{
    ...
    rsrc = FindResource( hModule, strRes, _T("DDS") );
    if( rsrc != NULL )
    {
    ...
    case WM_COMMAND:
        ...
        case IDC_COLORINTERVAL:
            if( HIWORD( wParam ) == EN_CHANGE )
            {
                ...
                if( _stscanf(sz, TEXT("%d"), &m_dwColorInterval) == 1 )
                    m_fTimeNextColorChange = 0.0f;
            }
            break;
        ...
        case IDC_MESHINTERVAL:
            if( HIWORD( wParam ) == EN_CHANGE )
            {
                ...
                if( _stscanf(sz, TEXT("%d"), &m_dwMeshInterval) == 1 )
                    m_fTimeNextMeshChange = 0.0f;
            }
            break;
        ...
        case IDC_TEXTUREINTERVAL:
            if( HIWORD( wParam ) == EN_CHANGE )
            {
                ...
                if( _stscanf(sz, TEXT("%d"), &m_dwTextureInterval) == 1 )
                    m_fTimeNextTextureChange = 0.0f;
            }
            break;
