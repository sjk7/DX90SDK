...
HRESULT SetTextureStageStatesForRendering( LPDIRECT3DDEVICE9 pd3dDevice )
{
    ...
    if( g_bTexturesChanged )
    {
        ...
        // Get the path to the texture then try to create
        if( FAILED( DXUtil_FindMediaFileCb( strPath, sizeof(strPath), _T("floor.bmp") ) ) ||
            FAILED( D3DXCreateTextureFromFileEx( pd3dDevice, strPath, 
                         D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, 
                         D3DPOOL_MANAGED, D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 
                         D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 0, NULL, NULL, &g_pFloorTexture ) ) )
            g_pFloorTexture = NULL;

        if( FAILED( DXUtil_FindMediaFileCb( strPath, sizeof(strPath), g_strTexture0 ) ) ||
            FAILED( D3DXCreateTextureFromFileEx( pd3dDevice, strPath, 
                         D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, 
                         D3DPOOL_MANAGED, D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 
                         D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 0, NULL, NULL, &g_pTexture0 ) ) )
            g_pTexture0 = NULL;

        if( FAILED( DXUtil_FindMediaFileCb( strPath, sizeof(strPath), g_strTexture1 ) ) ||
            FAILED( D3DXCreateTextureFromFileEx( pd3dDevice, strPath, 
                         D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, 
                         D3DPOOL_MANAGED, D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 
                         D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 0, NULL, NULL, &g_pTexture1 ) ) )
            g_pTexture1 = NULL;

        if( FAILED( DXUtil_FindMediaFileCb( strPath, sizeof(strPath), g_strTexture2 ) ) ||
            FAILED( D3DXCreateTextureFromFileEx( pd3dDevice, strPath, 
                         D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, 
                         D3DPOOL_MANAGED, D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 
                         D3DX_FILTER_TRIANGLE|D3DX_FILTER_MIRROR, 0, NULL, NULL, &g_pTexture2 ) ) )
            g_pTexture2 = NULL;
