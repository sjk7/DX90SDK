...
Namespace Lighting
    ...
    Public Class MyGraphicsSample
        ...
        Protected Overrides Sub FrameMove()
            ...
            ' VertexProcessingCaps.PositionalLights is not set, the device does not support 
            ' point or spot lights, so change light #2's type to a directional light.
            If Not Caps.VertexProcessingCaps.SupportsPositionalLights Then
            ...
            Dim r As Byte = CByte(Math.Abs(0.5F + 0.5F * x * &HFF))
            Dim g As Byte = CByte(Math.Abs(0.5F + 0.5F * y * &HFF))
            Dim b As Byte = CByte(Math.Abs(0.5F + 0.5F * z * &HFF))
