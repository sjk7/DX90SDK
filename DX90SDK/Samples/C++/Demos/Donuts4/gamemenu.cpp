...
HRESULT CMenuItem::Render( CD3DFont* pFont )
{
    ...
    ZeroMemory( &mtrlTitle, sizeof(D3DMATERIAL9) );
    mtrlTitle.Diffuse.r = mtrlTitle.Ambient.r = 1.0f;
    mtrlTitle.Diffuse.g = mtrlTitle.Ambient.g = 0.0f;
    mtrlTitle.Diffuse.b = mtrlTitle.Ambient.b = 0.0f;
    mtrlTitle.Diffuse.a = mtrlTitle.Ambient.a = 1.0f;
    ZeroMemory( &mtrlNormal, sizeof(D3DMATERIAL9) );
    mtrlNormal.Diffuse.r = mtrlNormal.Ambient.r = 1.0f;
    mtrlNormal.Diffuse.g = mtrlNormal.Ambient.g = 1.0f;
    mtrlNormal.Diffuse.b = mtrlNormal.Ambient.b = 1.0f;
    mtrlNormal.Diffuse.a = mtrlNormal.Ambient.a = 0.5f;
    ZeroMemory( &mtrlSelected, sizeof(D3DMATERIAL9) );
    mtrlSelected.Diffuse.r = mtrlSelected.Ambient.r = 1.0f;
    mtrlSelected.Diffuse.g = mtrlSelected.Ambient.g = 1.0f;
    mtrlSelected.Diffuse.b = mtrlSelected.Ambient.b = 0.0f;
    mtrlSelected.Diffuse.a = mtrlSelected.Ambient.a = 1.0f;
