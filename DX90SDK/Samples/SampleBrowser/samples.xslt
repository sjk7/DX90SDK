<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
	...
	<table width="97%" border="0" cellpadding="0" cellspacing="0">
		<xsl:for-each select="//sample" order-by="- @new; type; name">
			<tr>
			...
			<td valign="top" align="right">
				...
				<tr>
				    <td>
				        <img class="language" hspace="8" width="30" height="19">
				        <xsl:choose>
			...
			<td colspan="2" valign="top" height="30" style="padding-left: 22px">
				...
				<a class="links">
					...
					<xsl:when test="language[.='C++']">
						<xsl:attribute name="href">ms-its:../../Documentation/DirectX9/directx9_c.chm<xsl:value-of select="doc"/></xsl:attribute>
						<xsl:attribute name="title">../../Documentation/DirectX9/directx9_c.chm<xsl:value-of select="doc"/></xsl:attribute>
					</xsl:when>
				...
				<xsl:if test="readme[.!='']">
					<a class="links">
					<xsl:attribute name="href">..\..\"<xsl:value-of select="folder"/><xsl:value-of select="readme"/>"</xsl:attribute>
