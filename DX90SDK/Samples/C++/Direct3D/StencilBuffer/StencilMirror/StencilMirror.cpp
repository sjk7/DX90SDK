...
HRESULT CMyD3DApplication::RestoreDeviceObjects()
{
    ...
    // Set up a material
    ZeroMemory( &m_mtrlMirrorMaterial, sizeof(D3DMATERIAL9) );
    m_mtrlMirrorMaterial.Diffuse.r = m_mtrlMirrorMaterial.Ambient.r = 0.5f;
    m_mtrlMirrorMaterial.Diffuse.g = m_mtrlMirrorMaterial.Ambient.g = 0.8f;
    m_mtrlMirrorMaterial.Diffuse.b = m_mtrlMirrorMaterial.Ambient.b = 1.0f;
    m_mtrlMirrorMaterial.Diffuse.a = m_mtrlMirrorMaterial.Ambient.a = 1.0f;
