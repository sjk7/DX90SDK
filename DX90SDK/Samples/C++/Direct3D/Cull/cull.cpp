...
HRESULT CMyD3DApplication::RestoreDeviceObjects()
{
    ...
    {
        D3DLIGHT9 light;
        D3DXVECTOR3 vecLightDirUnnormalized(0.2f, -0.4f, 0.2f);
    ...
    // Set up materials
    ZeroMemory( &m_mtrlInside, sizeof(D3DMATERIAL9) );
    m_mtrlInside.Diffuse.r = m_mtrlInside.Ambient.r = 0.2f; // dark green
    m_mtrlInside.Diffuse.g = m_mtrlInside.Ambient.g = 0.6f;
    m_mtrlInside.Diffuse.b = m_mtrlInside.Ambient.b = 0.2f;
    m_mtrlInside.Diffuse.a = m_mtrlInside.Ambient.a = 0.5f;
    ZeroMemory( &m_mtrlOutside, sizeof(D3DMATERIAL9) );
    m_mtrlOutside.Diffuse.r = m_mtrlOutside.Ambient.r = 0.6f; // dark red
    m_mtrlOutside.Diffuse.g = m_mtrlOutside.Ambient.g = 0.2f;
    m_mtrlOutside.Diffuse.b = m_mtrlOutside.Ambient.b = 0.2f;
    m_mtrlOutside.Diffuse.a = m_mtrlOutside.Ambient.a = 0.5f;
    ZeroMemory( &m_mtrlInsideSlow, sizeof(D3DMATERIAL9) );
    m_mtrlInsideSlow.Diffuse.r = m_mtrlInsideSlow.Ambient.r = 0.7f; // pastel green
    m_mtrlInsideSlow.Diffuse.g = m_mtrlInsideSlow.Ambient.g = 1.0f;
    m_mtrlInsideSlow.Diffuse.b = m_mtrlInsideSlow.Ambient.b = 0.7f;
    m_mtrlInsideSlow.Diffuse.a = m_mtrlInsideSlow.Ambient.a = 0.5f;
    ZeroMemory( &m_mtrlOutsideSlow, sizeof(D3DMATERIAL9) );
    m_mtrlOutsideSlow.Diffuse.r = m_mtrlOutsideSlow.Ambient.r = 1.0f; // pastel red
    m_mtrlOutsideSlow.Diffuse.g = m_mtrlOutsideSlow.Ambient.g = 0.7f;
    m_mtrlOutsideSlow.Diffuse.b = m_mtrlOutsideSlow.Ambient.b = 0.7f;
    m_mtrlOutsideSlow.Diffuse.a = m_mtrlOutsideSlow.Ambient.a = 0.5f;
    ZeroMemory( &m_mtrlWhite, sizeof(D3DMATERIAL9) );
    m_mtrlWhite.Diffuse.r = m_mtrlWhite.Ambient.r = 1.0f; // white
