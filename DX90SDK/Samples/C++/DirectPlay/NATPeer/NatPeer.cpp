...
{
    TCHAR strPlayerName[MAX_PLAYER_NAME];   // Local player name
                      ...
                      LPTSTR pCmdLine, INT nCmdShow )
{
    ...
    DXUtil_ReadStringRegKeyCch( hDPlaySampleRegKey, TEXT("Player Name"), 
                             g_DlgOptions.strPlayerName, MAX_PLAYER_NAME, TEXT("TestPlayer") );
...
VOID OnInitConnectDialog( HWND hDlg )
{
    ...
    SendDlgItemMessage( hDlg, IDC_PLAYER_NAME, EM_LIMITTEXT, MAX_PLAYER_NAME-1, 0 );
...
{
    // Player Name                
    GetDlgItemText( hDlg, IDC_PLAYER_NAME, g_DlgOptions.strPlayerName, MAX_PLAYER_NAME );
    g_DlgOptions.strPlayerName[MAX_PLAYER_NAME-1] = 0;
...
HRESULT Host() 
{
    ...
    WCHAR wstrPlayer[MAX_PLAYER_NAME] = {0};
    ...
    DXUtil_ConvertGenericStringToWideCch( wstrPlayer, g_DlgOptions.strPlayerName, MAX_PLAYER_NAME );
